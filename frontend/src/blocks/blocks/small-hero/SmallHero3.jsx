 ...
 *
 * Demos:
 * - [SmallHero3](https://www.ciisic.org/blocks/small-hero/small-hero3)
 *
 * API
 * - [SmallHero3 API](https://ciisic.gitbook.io/ciisic/ui-kit/development/components/smallhero/smallhero3#props-details)
 */
