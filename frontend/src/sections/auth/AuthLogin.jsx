...
const userCredentials = [
  { title: 'Super Admin', email: 'super_admin@ciisic.org', password: 'Super@123' },
  { title: 'Admin', email: 'admin@ciisic.org', password: 'Admin@123' },
  { title: 'User', email: 'user@ciisic.org', password: 'User@123' }
];
...
export default function AuthLogin({ inputSx }) {
  ...
  const {
    ...
    reset,
    formState: { errors }
  } = useForm({ defaultValues: { email: 'super_admin@ciisic.org', password: 'Super@123' } });
        ...
        <Stack gap={2}>
          <Box>
            ...
            <OutlinedInput
              ...
              placeholder="example@ciisic.org"
              fullWidth
