  ...
  return (
    <div className="h-[100vh] flex flex-col md:flex-row w-[100vw] bg-white text-zinc-900 overflow-hidden select-none">
        ...
        <div className="w-full max-w-sm">
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-4" onSubmit={onSignIn}>
              ...
              <button type="submit" className="w-full rounded-2xl bg-zinc-900 hover:bg-zinc-800 text-white py-3.5 font-bold transition-all mt-2 active:scale-[0.99] cursor-pointer text-sm shadow-sm">
                Sign In
              </button>
            </form>
            ...
            <button type="button" onClick={onGoogleSignIn} className="w-full flex items-center justify-center gap-2.5 border border-zinc-200 rounded-2xl py-3 hover:bg-zinc-50 transition-all font-bold text-zinc-700 bg-white text-sm cursor-pointer active:scale-[0.99] shadow-sm">
                <GoogleIcon />
      ...
      <section className="hidden md:block flex-1 relative bg-zinc-50">
        {heroImageSrc && (
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url(${heroImageSrc})` }}></div>
        )}
      </section>
    </div>
  );
