  ...
  return (
    <div className="space-y-6 text-left pb-12 select-none animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      <div className="border-b border-zinc-100 pb-4">
        <h1 className="text-3xl font-extrabold tracking-tight text-zinc-900 leading-tight">Console Settings</h1>
        <p className="text-sm text-zinc-500 font-medium">Configure security keys and manage system alert coordinates</p>
      </div>

      {/* Grid split */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left 2 cols: security password form */}
        <div className="lg:col-span-2 space-y-6">
          <form onSubmit={handleUpdatePassword} className="bg-white border border-zinc-150 rounded-3xl p-6 shadow-sm space-y-4 text-left">
            <h3 className="text-sm font-extrabold text-zinc-900 uppercase tracking-wider flex items-center gap-2 border-b border-zinc-50 pb-3">
              <Shield className="w-4.5 h-4.5 text-indigo-600" /> Account Security
            </h3>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-3 py-2.5 border border-zinc-200 bg-zinc-50/50 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:bg-white font-semibold text-zinc-800"
                required
              />
            </div>
        ...
        {/* Right side alert checkbox options */}
        <div className="space-y-6">
          <div className="bg-white border border-zinc-150 rounded-3xl p-6 shadow-sm space-y-4 text-left">
            <h3 className="text-sm font-extrabold text-zinc-900 uppercase tracking-wider flex items-center gap-2 border-b border-zinc-50 pb-3">
              <Bell className="w-4.5 h-4.5 text-indigo-600" /> System Alerts
            </h3>

            <div className="space-y-4 text-xs font-bold text-zinc-700">
              <label className="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" defaultChecked className="rounded border-zinc-300 text-indigo-650 focus:ring-indigo-500" />
                <span>Email me on new student verifications</span>
              </label>

              <label className="flex items-center gap-2.5 cursor-pointer">
                <input type="checkbox" defaultChecked className="rounded border-zinc-300 text-indigo-650 focus:ring-indigo-500" />
                <span>Notify on weekly placement index edits</span>
              </label>
            </div>
          </div>
        </div>
